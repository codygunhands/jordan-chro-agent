...
export class AgentService {
  ...
  private buildSystemPrompt(
    ...
    const agentName = process.env.AI_EMPLOYEE_NAME || 'jordan';
    const agentRole = process.env.AI_ROLE || 'CHRO';
    
    let prompt = `You are ${agentName === 'jordan' ? 'Jordan' : agentName}, ${agentRole === 'CHRO' ? 'Chief Human Resources Officer' : agentRole}.
